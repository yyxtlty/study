...
public class TestObjSerializeAndDeserialize {
    ...
    private static void SerializePerson() throws FileNotFoundException,
        ...
        ObjectOutputStream oo = new ObjectOutputStream(new FileOutputStream(
                new File("/Users/wsl/IdeaProjects/study/test/src/main/resources/erson.out")));
        //oo.writeBytes();
        oo.writeObject(person);

        System.out.println(person.toString().getBytes().hashCode());
    ...
    private static Person DeserializePerson() throws Exception, IOException {
       /* ObjectInputStream ois = new ObjectInputStream(new FileInputStream(
        ...
        FileInputStream ois = new FileInputStream(
                new File("/Users/wsl/IdeaProjects/study/test/src/main/resources/Person.out"));
        String str = "";
        byte[] b = new byte[20];
        int len ;
